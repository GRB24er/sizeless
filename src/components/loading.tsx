...
export default function Loading() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-[#0A1628] via-[#0D1F35] to-[#0A1628] relative overflow-hidden">
      ...
      />
      <div
        className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] bg-emerald-800/10 rounded-full blur-[150px] animate-pulse"
        ...
        <div className="mb-12">
          <div className="relative inline-flex items-center justify-center">
            ...
            <div
              ...
              style={{
                borderTopColor: "rgba(5, 150, 105, 0.8)",
            ...
            {/* Middle pulsing ring */}
            <div
              className="absolute w-24 h-24 rounded-full border border-emerald-500/40"
            ...
            <div
              ...
              style={{
                borderBottomColor: "rgba(212, 168, 83, 0.8)",
